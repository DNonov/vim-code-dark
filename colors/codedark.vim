...
let s:cdFront = {'gui': '#AAAAAA', 'cterm': s:cterm05, 'cterm256': '188'}
...
let s:cdGray = {'gui': '#AAAAAA', 'cterm': s:cterm04, 'cterm256': '08'}
...
call <sid>hi('Noise', s:cdFront, s:cdBack, 'none', {})
...
call <sid>hi('SpellBad', s:cdFront, s:cdRed, 'none', {})
...
call <sid>hi('Constant', s:cdLightGreen, {}, 'none', {})
...
call <sid>hi('Repeat', s:cdOrange, {}, 'none', {})
...
call <sid>hi('Special', s:cdLightBlue, {}, 'none', {})
...
call <sid>hi('Underlined', s:cdNone, {}, 'none', {})
call <sid>hi("Conceal", s:cdFront, s:cdBack, 'none', {})

call <sid>hi('Ignore', s:cdFront, {}, 'none', {})

call <sid>hi('Error', s:cdRed, {}, 'none', s:cdRed)
...
call <sid>hi('cssColor', s:cdLightGreen, {}, 'none', {})
...
call <sid>hi('pythonFunction', s:cdGreen, {}, 'none', {})
